...
public class GestoMaoParaCima extends Gesture {
    ...
    //Caso precise usar os pontos iniciais de alguma junta, que se encontram dentro de um vetor(point), podendo ser acessado pelo 'getPoint(i)' passando como parâmetro a posição do vetor que deseja usar.
    //Para o uso desse vetor é necessário chamar o método 'setStartingPoints(boolean)' e passar true como parâmetro
